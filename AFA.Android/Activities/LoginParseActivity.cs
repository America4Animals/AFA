...
namespace AFA.Android.Activities
{
    ...
    public class LoginParseActivity : FragmentActivity
    {
		...
		{
            LoginParseActivity _owner;

			public MyStatusCallback(LoginParseActivity owner)
			{
				_owner = owner;
			}
		...
		class MyUserInfoChangedCallback : Java.Lang.Object, LoginButton.IUserInfoChangedCallback
		{
            ...
            public MyUserInfoChangedCallback(LoginParseActivity owner)
			{
				_owner = owner;
			}
